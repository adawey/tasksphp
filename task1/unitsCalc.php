<?php
    if($_POST){
        ...
        if($num <= 99){
            ...
            $tax = $num * 0.50 * 0.20;
            $result = $out + $tax ;
        }elseif($num <= 199 && $num > 99 ) {
            $out = $num * 0.75;
            $tax = $num * 0.75 * 0.20;
            $result = $out + $tax ;
        }elseif($num <= 299 && $num > 199 ) {
            $out = $num * 1.20;
            $tax = $num * 1.20 * 0.20;
            $result = $out + $tax ;
        }elseif($num > 199  ) {
...
<body>
    ...
    <div class="container">
        ...
        <?php if(isset($tax)){ echo "<div class='result alert alert-success'> Tax price is $tax </div>"; } ?>
        <?php if(isset($result)){ echo "<div class='result alert alert-success'>total bill Is $result </div>"; } ?>

<?php
    if($_POST){
        ...
        if($num < 0){
            $out = 'the number is negative ';
        }else{
            $out = 'the number is positive ';
        }
    }
...
<body>
    ...
    <div class="container">
        ...
        <div class='title'>
            <h1>check if the number negative or positive </h1>
        </div>
        <div class="row mt-5">
            <div class="col-6 offset-3 ">
                <form method="post" action="">
                    <div class="form-group ">
                        <label for="Number_One">Number </label>
                    ...
                    <button name="submit" type="submit" class="btn btn-primary rounded form-control">check</button>
                </form>
            </div>
        </div>
